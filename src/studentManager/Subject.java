...
public class Subject {
	...
	public Subject(String subjectName, int subjectNum, double subrank, String subjectTime, String professor,
			String tern, String timeTable) {
		super();
		this.subjectName = subjectName;
	...
	public void printsubject() {
		System.out.print("[ 과목:"+subjectName+"| 과목번호:"+subjectNum+"] ");
	}
